...
router.delete('/teacher/:id/fields', auth.isTeacher, teacher.removeTeacherFromFields)
router.delete('/teacher/:id/topics', auth.isTeacher, teacher.removeTeacherFromTopics)
